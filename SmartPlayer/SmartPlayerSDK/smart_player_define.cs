...
namespace NT
{
     ...
     */
     [UnmanagedFunctionPointerAttribute(CallingConvention.StdCall)]
    public delegate void SP_SDKCaptureImageCallBack(IntPtr handle, IntPtr user_data, UInt32 result, IntPtr file_name);
     ...
     */
      ...
      */
     [UnmanagedFunctionPointerAttribute(CallingConvention.StdCall)]
     public delegate void SP_SDKUserDataCallBack(IntPtr handle, IntPtr user_data,
        UInt32 data_type,
        IntPtr data,
        UInt32 size,
        UInt64 timestamp,
      ...
      */
     [UnmanagedFunctionPointerAttribute(CallingConvention.StdCall)]
     public delegate void SP_SDKSEIDataCallBack(IntPtr handle, IntPtr user_data,
        IntPtr data,
        UInt32 size,
        UInt64 timestamp,
        UInt64 reserve1,
